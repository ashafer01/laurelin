...
#######################
#
# modified by Alex Shafer 2016.06.27
# original copied from: https://github.com/cannatag/ldap3/blob/20549d8268fe4ae8dbffb87dad722211861b159d/ldap3/protocol/rfc4511.py
#
# - removed external import of LDAP_MAX_INT for use outside of ldap3
# - updated component names to be identical to the RFC where needed
...
class SearchResultEntry(Sequence):
    ...
    componentType = NamedTypes(NamedType('objectName', LDAPDN()),
